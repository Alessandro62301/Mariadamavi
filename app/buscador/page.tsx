  ...
  async function abrirWhatsApp(oferta: Oferta) {
    ...
    try {
      ...
      const msg = encodeURIComponent(
        `Oi! Vi o ${oferta.modelo} (${oferta.cor}, ${oferta.condicao}) por ${oferta.valor} no Conecta Lojista e quero saber se ainda está disponível.`
      );
      ...
      <div className="busca-body">
              ...
              <div className="oferta-row" key={oferta.id}>
                <div className="oferta-info">
                  ...
                  <div className="oferta-tags">
                    <span className={`tag ${oferta.condicao === "Usado" ? "usado" : "novo"}`}>{oferta.condicao}</span>
        ...
        {resultado && totalPaginas > 1 && (
          <div className="paginacao">
            ...
            <button onClick={() => setPage((p) => Math.min(totalPaginas, p + 1))} disabled={page >= totalPaginas}>›</button>
          </div>
        )}
      </div>
    </div>
