...
// `fornecedores` é sempre da mesma coleta das `ofertas`: a origem recria as
// linhas com ids novos a cada scrape, então não dá pra reaproveitar o
// fornecedor de uma coleta anterior — aquele id nunca mais aparece.
